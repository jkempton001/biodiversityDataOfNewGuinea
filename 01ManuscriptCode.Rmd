...
frogSEAsiaOccData <- read_csv("cleaned_occ_data/frogsOccDatacleaned_20260108.csv")
...
load("input_dataframes/frogsData_20260201.RData")
...
# Define levels once and reuse everywhere (avoids dash/typo mismatches)
frogs_binsAlpha <- c("0","1-10","11–20","21–30","31–40","41–50")
...
# Define levels once and reuse everywhere (avoids dash/typo mismatches)
binsAlpha <- c("0","1-10","11–20","21–30","31–40","41–50",
                "51–60",">60")
...
# Generate date stamp and save cleaned dataset ----
date_stamp <- format(Sys.Date(), "%Y%m%d")
output_filename <- paste0(getwd(),"/figures/", "frogDescYrs_", date_stamp, ".png")

ggsave(
  filename = output_filename,  # file name and extension
  plot     = frogDescYrsPlot,       # your ggplot object
  width    = 8,                          # width in inches (adjust as needed)
  height   = 6,                          # height in inches (adjust as needed)
  units    = "in",                        # units for width/height
  dpi      = 300                          # resolution; affects rasterized elements
...
# Generate date stamp and save cleaned dataset ----
date_stamp <- format(Sys.Date(), "%Y%m%d")
output_filename <- paste0(getwd(),"/figures/", "birdDescYrs_", date_stamp, ".png")
