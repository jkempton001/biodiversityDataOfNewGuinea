...
max_n <- max(frogCollYrs$n)
max_cum <- max(frogCollYrs$cum_n)
scale_factor <- max_cum / max_n

frogCollYrsPlot = ggplot(frogCollYrs, aes(x = year)) +
  ...
  scale_y_continuous(
    name = "Cumulative number of occurrence records",
    sec.axis = sec_axis(
      ~ . / scale_factor,
      name = "Annual number of occurrence records"
    )
  ) +
  
  labs(
    title = "Annual and Cumulative Frog Occurrence Records",
...
max_n <- max(birdCollYrs$n)
max_cum <- max(birdCollYrs$cum_n)
scale_factor <- max_cum / max_n

birdCollYrsPlot = ggplot(birdCollYrs, aes(x = year)) +
...
max_n <- max(mammalCollYrs$n)
max_cum <- max(mammalCollYrs$cum_n)
scale_factor <- max_cum / max_n

mammalCollYrsPlot = ggplot(mammalCollYrs, aes(x = year)) +
  ...
  labs(
    title = "Annual and Cumulative Mammal Occurrence Records",
    x = "Year of collection"
  ) +
...
max_n <- max(plantCollYrs$n)
max_cum <- max(plantCollYrs$cum_n)
scale_factor <- max_cum / max_n

plantCollYrsPlot = ggplot(plantCollYrs, aes(x = year)) +
  ...
  labs(
    title = "Annual and Cumulative Plant Occurrence Records",
    x = "Year of collection"
  ) +
...
max_n <- max(squamateCollYrs$n)
max_cum <- max(squamateCollYrs$cum_n)
scale_factor <- max_cum / max_n

squamateCollYrsPlot = ggplot(squamateCollYrs, aes(x = year)) +
  ...
  labs(
    title = "Annual and Cumulative Squamate Occurrence Records",
    x = "Year of collection"
  ) +
