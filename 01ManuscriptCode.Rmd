...
frogSEAsiaOcc <- read_csv("frogsOccDataStandardised_20260108.csv")
...
# Import the combined raw dataset from GBIF download script
cat("Loading raw occurrence data...\n")
mammalSEAsiaOcc <- read_csv("mammalsOccDataStandardised_20260108.csv")
...
# Import the combined raw dataset from GBIF download script
cat("Loading raw occurrence data...\n")
birdSEAsiaOcc <- read_csv("birdsOccDataStandardised_20260105.csv")
...
# Import the combined raw dataset from GBIF download script
cat("Loading raw occurrence data...\n")
squamateSEAsiaOcc <- read_csv("squamatesOccDataStandardised_20260105.csv")
...
write_csv(squamatesSEAsiaOccData, output_filename)
cat("Dataset saved as:", output_filename, "\n")
...
# Import the combined raw dataset from GBIF download script
cat("Loading raw occurrence data...\n")
plantSEAsiaOcc <- read_csv("plantsOccDataStandardised_20260105.csv")
